...
class TestNotificationManager(BaseModelTestCase):
    ...
    def test_get_notifications_email(self):
    ...
    def test_get_notifications_push(self):
    ...
    def test_mark_notification_basic_read(self):
    ...
    def test_mark_notification_basic_unread(self):
